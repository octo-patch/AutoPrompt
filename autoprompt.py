#!/usr/bin/env python3
"""autoprompt — evolve any text artifact using LLM-powered natural selection.

Prompts, code, configs, copy — feed it a seed and fitness criteria,
and it breeds better versions through intelligent mutation.

Uses CLI tools (claude or codex) instead of API keys. Zero dependencies.

Usage:
  python3 autoprompt.py seed.txt criteria.md --target 9.0
  python3 autoprompt.py prompt.md criteria.md -e codex --patience 3
  python3 autoprompt.py seed.py criteria.md -b "python3 bench.py {file}"
"""
...
def evolve(seed_path, criteria_path, generations=10, population=3, bench_cmd=None,
    ...
    print(f"\n{'='*60}")
    print(f"  autoprompt — natural selection for text")
    print(f"{'='*60}")
...
if __name__ == "__main__":
    p = argparse.ArgumentParser(
        description="autoprompt — evolve any text artifact using LLM-powered natural selection",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
examples:
  # evolve a prompt (LLM judges quality)
  python3 autoprompt.py prompt.txt criteria.md --target 9.0

  # evolve code with a benchmark
  python3 autoprompt.py seed.py criteria.md -b "python3 bench.py {file}"
